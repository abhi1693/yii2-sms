...
1. Make sure you have the latest version of Yii2-Sms and see if the issue still exists.

2. Search for similar issues. It's possible somebody has encountered this bug already.

3. Provide information including: the version of PHP, Yii and Yii2-Sms, the type of
